...
public class EmojiResourceTokenType extends IElementType {
	public EmojiResourceTokenType(@NotNull String debugName) {
		super(debugName, EmojiResourceLanguage.INSTANCE);
	}

	@Override
	public String toString() {
		return "EmojiResourceTokenType." + super.toString();
	}
}
