...
public class PrefixResourceEmojiKeyImpl extends ASTWrapperPsiElement implements PrefixResourceEmojiKey {

  public PrefixResourceEmojiKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PrefixResourceVisitor visitor) {
    visitor.visitEmojiKey(this);
  }
